...
public class UserAgentParserTask extends TaskBase {
    ...
    public UserAgentParserTask(Configuration configuration, ActorSystem system) {
        ...
        this.cache = CacheBuilder.newBuilder().maximumSize(100).expireAfterWrite(2, TimeUnit.HOURS).build();
    }
