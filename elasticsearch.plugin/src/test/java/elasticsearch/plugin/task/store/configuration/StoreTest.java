...
public class StoreTest extends ElasticsearchTestBase {
    ...
    public void testReadAll() throws Exception {
        ...
        try {
            ...
            Thread.sleep(5000);
            List<EventTransformerConfiguration> eventTransformerConfigurations = store.readAll(TaskType.Transform, EventTransformerConfiguration.class);
            Assert.assertEquals(1, eventTransformerConfigurations.size());
            List<EventStorageConfiguration> serviceConfigurations = store.readAll(TaskType.Store, EventStorageConfiguration.class);
    ...
    public void testReadConfiguration() throws Exception {
        ...
        try {
            ...
            Thread.sleep(5000);
            EventStorageConfiguration readConfiguration = store.readConfiguration("S", TaskType.Store, EventStorageConfiguration.class);
    ...
    public void testUpdateConfiguration() throws Exception {
        ...
        try {
            ...
            Thread.sleep(5000);
            readConfiguration = store.readConfiguration("S", TaskType.Store, EventStorageConfiguration.class);
